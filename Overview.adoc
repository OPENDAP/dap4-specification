...
and including ideas that emerged as DAP gained prominence across the Earth sciences. Therefore
...
Groups provide a way to organize collections of variables and dimensions and to encode these
